...
def main():
    ...
    if os.path.exists(REPORT_PATH):
        ...
        # graph.render("res/output/dt_{}_{}_{}".format("PyTorchNet", "trustee", dt.get_n_leaves()))

        # students = trustee.get_students()
        ...
        #         )
        #         graph = graphviz.Source(dot_data)
        #         graph.render("res/output/trees/dt_{}_{}_{}_{}_{}".format("PyTorchNet", "trustee", dt.get_n_leaves(), reward, idx))
