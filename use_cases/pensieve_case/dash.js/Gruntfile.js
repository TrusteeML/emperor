module.exports = function (grunt) {
        ...
        copy: {
            dist: {
                ...
                src: [
                    ...
                    'dash.mediaplayer.min.js.map',
                    'dash.protection.min.js',
                    'dash.protection.min.js.map',
                    'dash.all.debug.js',
                    'dash.all.debug.js.map',
                    'dash.reporting.min.js',
                    'dash.reporting.min.js.map',
                    'dash.mediaplayer.debug.js',
                    'dash.mediaplayer.debug.js.map',
        ...
        browserify: {
            mediaplayer: {
                ...
                options: {
                    ...
                    plugin: ['browserify-derequire', 'bundle-collapser/plugin'],
                    transform: [
                        [
                            'babelify',
                            {
    ...
    grunt.registerTask('dist', [
        ...
        'browserify:reporting',
        'browserify:all',
        'babel:es5',
        'minimize',
        'copy:dist',
    ]);
    // grunt.registerTask('dist', ['clean', 'force:jshint', 'force:jscs', 'browserify:mediaplayer', 'browserify:protection', 'browserify:reporting', 'browserify:all']);
    ...
    grunt.registerTask('lint', ['force:jshint', 'force:jscs']);
